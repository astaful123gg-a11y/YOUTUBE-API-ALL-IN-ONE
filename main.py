...
def base_opts():
    ...
    opts = {
        ...
        "socket_timeout": 20,
        "retries": 3,
        # web_creator works with the EJS challenge solver
        "extractor_args": {"youtube": {"player_client": ["web_creator", "web"]}},
        # Allow yt-dlp to download the JS challenge solver from GitHub
        "remote_components": {"ejs:github"},
        # Provide the node.js runtime path explicitly
...
def _do_download(url: str, audio_only: bool):
    ...
    if audio_only:
        # No ext filter — pick whatever audio is available, then convert to mp3
        ...
        # No ext filter — pick best video+audio, merge to mp4
